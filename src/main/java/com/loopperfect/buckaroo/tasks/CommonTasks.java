...
public final class CommonTasks {
    ...
    public static String generateBuckarooDeps(final ImmutableList<RecipeIdentifier> dependencies) throws IOException {
        Preconditions.checkNotNull(dependencies);
        final String buckarooDeps = Either.orThrow(
            BuckFile.list(
                "BUCKAROO_DEPS",
                dependencies.stream()
                    .map(RecipeIdentifier::encode)
                    .collect(toImmutableList())));
//        final String buckarooPlatformDeps = Either.orThrow(
//            BuckFile.list(
//                "BUCKAROO_PLATFORM_DEPS",
//                dependencies.stream()
//                    .map(ResolvedDependencyReference::encode)
//                    .collect(toImmutableList())));
        final String buckarooPlatformDeps = "BUCKAROO_PLATFORM_DEPS = []";
        return "# Generated by Buckaroo, do not edit! \n" +
            "# This file should not be tracked in source-control. \n" +
            "# Visit https://buckaroo.pm for more information. \n" +
            buckarooDeps +
            "\n\n" +
            buckarooPlatformDeps +
            "\n";
    }
