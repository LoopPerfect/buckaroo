...
public final class SummaryView {
    ...
    public static Observable<Component> render(final Observable<Event> observable) {
        ...
        final Observable<Event> events = observable; // .publish().autoConnect(3); //.share();
        ...
        return Observable.combineLatest(
            ImmutableList.of(
                ...
                notifications),
            (Function<Object[], List<Component>>) objects -> Arrays.stream(objects)
                .map(x -> StackLayout.of((List<Component>)x))
