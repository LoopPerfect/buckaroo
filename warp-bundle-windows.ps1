...
.\warp-packer.exe --arch windows-x64 --input_dir ./buckaroo-cli/bin/Release/netcoreapp2.1/win10-x64 --exec ./warp/buckaroo-windows.exe --output ./warp/buckaroo-windows.exe
